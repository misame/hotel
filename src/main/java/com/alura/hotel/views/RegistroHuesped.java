    ...
    public RegistroHuesped(Reserva reserva) {
        ...
        btnguardar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                ControladorReservas cr = new ControladorReservas(huesped, reserva);
                cr.registro();
                ...
                int option = JOptionPane.showConfirmDialog(null, mensaje, "Se registr� con exito", JOptionPane.DEFAULT_OPTION);

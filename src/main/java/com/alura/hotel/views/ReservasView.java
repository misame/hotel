...
public class ReservasView extends JFrame {
    ...
    public ReservasView() {
        ...
        // Codigo que crea los elementos de la interfaz grafica
        ...
        lblSiguiente.setFont(new Font("Roboto", Font.PLAIN, 14));
        ...
        btnsiguiente.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
                    ...
                    Reserva reserva = new Reserva(fechaEntrada, fechaSalida, valor, txtFormaPago.getSelectedItem().toString());                   
    ...
    //Calculo del valor de acuerdo a la cantidad de dias
    private void valor() {
        BigDecimal valorDiario = new BigDecimal("20");
        Date entrada = txtFechaEntrada.getDate();
        Date salida = txtFechaSalida.getDate();
        fechaEntrada = entrada.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
        fechaSalida = salida.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
        Long dias = ChronoUnit.DAYS.between(fechaEntrada, fechaSalida);
        valor = valorDiario.multiply(new BigDecimal(dias));
        txtValor.setText(valor.toString());
    }

    // Codigo que permite mover la ventana por la pantalla segun la posicion de "x"
    // y "y"
